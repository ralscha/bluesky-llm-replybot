...
) RETURNING id, message_uri, message_cid, author_did, author_handle, message_text, llm_response, reply_uri, reply_cid, status, retry_count, error_message, model_name, received_at, processing_started_at, completed_at
`
